...
//import android.os.RemoteException;import com.xdja.SafeKey.JNIAPI;
...
//        }
    ...
    @Override
    public byte[] encryptKey(byte[] key, int keylen) {
...
//        }
    ...
    @Override
    public byte[] decryptKey(byte[] seckey, int seckeylen) {
